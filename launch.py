            ...
            for segment_width in list_segment_width:
                for fraction_vertical in list_fraction_vertical:
                    for use_external in list_use_external:
                        iostat_cmd = f"iostat -g ALL -x -t 1 | grep ALL > iostat_main_{log_element_count}_{log_mem_size}_{segment_width}_{generate_data}_{use_external}_{fraction_vertical}.txt &"
